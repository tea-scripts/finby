...
/** Dismissible install affordance, mobile-only, rendered in the top banner
 *  stack (below the verify-email banner) so the floating bottom nav never
 *  covers it. Android/Chrome → one-tap native install; iOS Safari → "Install
 *  app" opens a guided Add-to-Home-Screen sheet (Apple allows no programmatic
 *  install). Renders nothing when already installed or dismissed. */
export function InstallBanner() {
  ...
  return (
    <>
      <div className="flex items-center gap-3 border-b border-line bg-surface/90 px-4 py-2.5 backdrop-blur md:hidden">
